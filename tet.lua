...
local Tabs = {
    ...
    Stats = Window:AddTab({ Title = "Tab Sea Event", Icon = "anchor" }),
    Info = Window:AddTab({ Title = "Tab Items", Icon = "sword" }),
    Seaev = Window:AddTab({ Title = "Tab Setting", Icon = "settings" }),
    Player = Window:AddTab({ Title = "Sever Status", Icon = "user" }),
    Teleport = Window:AddTab({ Title = "Tab Stats", Icon = "plus-circle" }),
    Fruit = Window:AddTab({ Title = "Tab Player", Icon = "baby" }),
    Raid = Window:AddTab({ Title = "Tab Teleport", Icon = "palmtree" }),
    Race = Window:AddTab({ Title = "Tab Visual", Icon = "align-vertical-distribute-center" }),
    Shop = Window:AddTab({ Title = "Tab Fruit Blox Esp", Icon = "apple" }),
    Misc = Window:AddTab({ Title = "Tab Dungeon", Icon = "swords" }),
    Hop = Window:AddTab({ Title = "Tab Race V4", Icon = "clock" }),
    Setting = Window:AddTab({ Title = "Tab Shop", Icon = "shopping-cart" }),
}
