...
local Tabs = {
    ...
    OPT = Window:AddTab({ Title = "Tab Quest Sea", Icon = "chevrons-right" }),
...
local SettingFarm = Tabs.OPT:AddSection("Auto Second Sea")
    
local Togglesea2go = Tabs.OPT:AddToggle("Togglesea2go", {Title = "Auto Sea 2", Description = "", Default = false })
...
local SettingFarm = Tabs.OPT:AddSection("Auto Third Sea")
        
local Togglesea3go = Tabs.OPT:AddToggle("Togglesea3go", {Title = "Auto sea 3", Description = "", Default = false })
...
local ToggleEvoRace = Tabs.OPT:AddToggle("ToggleEvoRace", {Title = "Auto Evo Race V2",Description = "",Default = false })
...
local Togglehakiqs = Tabs.Setting:AddToggle("Togglehakiqs", {Title = "Use Ken Haki", Description = "", Default = false })
