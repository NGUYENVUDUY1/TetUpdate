...
local Window = Fluent:CreateWindow({
    Title = "Hiru Hub",
    SubTitle = "Version Beta 4⁵ | By Nguyen Vu Duy ",
    TabWidth = 160,
...
local Tabs = {
    ...
    Items = Window:AddTab({ Title = "Tab Items", Icon = "align-vertical-distribute-center" }),
...
local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Auto Farm Dough King (Need Spawn)",Description = "", Default = false })
...
local ToggleHallow = Tabs.Items:AddToggle("ToggleHallow", {Title = "Auto Hallow Scythe [Fully]",Description = "", Default = false })
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.Items:AddToggle("ToggleYama", {Title = "Auto Get Yama",Description = "", Default = false })
        ...
        local ToggleTushita = Tabs.Items:AddToggle("ToggleTushita", {Title = "Auto Get Tushita",Description = "", Default = false })
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Items:AddToggle("ToggleHoly", {Title = "Auto Holy Torch",Description = "", Default = false })
...
local ToggleAutoSoulGuitar = Tabs.Main:AddToggle("ToggleAutoSoulGuitar", {Title = "Auto get Soulguitar[Sea3]",Description = "", Default = false })
