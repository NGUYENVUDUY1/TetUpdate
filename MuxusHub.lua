...
function getAllBladeHitsPlayers(Sizes)
	...
	local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/DuongTGMXSADCAT/NewHub/main9/alpwleoekebekelep0wbsbs.txt",true))()
    ...
    while wait(.1) do
        if _G.StartLock then
            if game.Players.localPlayer.Data.Level.Value >= _G.NumberLock then
                game.Players.localPlayer:Kick("à¸à¸²à¸£à¸Ÿà¸²à¸¡à¹€à¸ªà¸£à¹‡à¸ˆà¸ªà¸´à¹‰à¸™à¹à¸¥à¹‰à¸§")
            end
        end
    end
end)
...
ImageButton1.Image = "rbxassetid://15935972897"
