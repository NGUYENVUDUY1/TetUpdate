...
local ToggleAutoT = Tabs.Player:AddToggle("ToggleAutoT", {Title = "Enabled Turn On V3", Description = "", Default = false })
...
local ToggleAutoY = Tabs.Player:AddToggle("ToggleAutoY", {Title = "Enabled Turn On V4", Description = "", Default = false })
