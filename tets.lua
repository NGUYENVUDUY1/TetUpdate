...
WindowStroke.Color = Color3.fromRGB(32, 36, 34)
...
LOGO.Name = "LOGO"
LOGO.Parent = MAIN
LOGO.BackgroundColor3 = Color3.fromRGB(32, 36, 34)
...
TITLE.Text = "HIRU HUB NO KEY"
TITLE.TextColor3 = Color3.fromRGB(235, 52, 52)
TITLE.TextScaled = true
TITLE.TextSize = 14.000
TITLE.TextWrapped = true

LOADING.Name = "LOADING HIRU HUB"
LOADING.Parent = MAIN
...
wait(1)
LOADING.Text = "LOADING  HUB"
BAR:TweenSize(UDim2.new(0, 150,0, 15), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
wait(1)
LOADING.Text = "HIRU HUB HELLO " ..game.Players.LocalPlayer.DisplayName.. " From: ".. code
...
wait(1)
LOADING.Text = "SCRIPT HIRU HUB NO KEY"
...
if Third_Sea then
    local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Auto Farm Bone", Description = "", Default = false })
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "Auto Farm Cake Prince & Dough King", Description = "", Default = false })
    ...
    local ToggleSpawnCake = Tabs.Main:AddToggle("ToggleSpawnCake", {Title = "Auto Spawn Cake Prince", Description = "", Default = true })
