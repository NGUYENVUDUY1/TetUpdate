...
local Window = SpeedHubX:CreateWindow({
    Title = "Hiru Hub",
    SubTitle = "Version Beta 8¹ | By Nguyen Vu Duy",
    TabWidth = 160,
...
local Tabs = {
    ...
    FRM = Window:AddTab({ Title = "Tab Auto Farm", Icon = "" }),
    ...
    Status = Window:AddTab({ Title = "Sever Status", Icon = "" }),
...
ToggleAutoY:OnChanged(function(Value)
 ...
 spawn(function()
    ...
    local ToggleLevel = Tabs.FRM:AddToggle("ToggleLevel", {
...
local ToggleCastleRaid = Tabs.FRM:AddToggle("ToggleCastleRaid", {
...
local ToggleBringMob = Tabs.FRM:AddToggle("ToggleBringMob", {Title = "Bring Mob",Description = "", Default = true })
...
local ToggleWhite = Tabs.FRM:AddToggle("ToggleWhite", {Title = "White Screen",Description = "", Default = false })
	...
	local MiscFarm = Tabs.FRM:AddSection("Ectoplasm Farm")
    local ToggleVatChatKiDi = Tabs.FRM:AddToggle("ToggleVatChatKiDi", {
...
local boss = Tabs.FRM:AddSection("Boss Farm")
    ...
    local DropdownBoss = Tabs.FRM:AddDropdown("DropdownBoss", {
        Title = "choose boss",
        Description = "",
        Values = tableBoss,
        Multi = false,
	...
	local ToggleAutoFarmBoss = Tabs.FRM:AddToggle("ToggleAutoFarmBoss", {
...
local Mastery = Tabs.FRM:AddSection("Mastery Farm")
    local DropdownMastery = Tabs.FRM:AddDropdown("DropdownMastery", {
    ...
    local ToggleMasteryFruit = Tabs.FRM:AddToggle("ToggleMasteryFruit", {
    ...
    local SliderHealt = Tabs.FRM:AddSlider("SliderHealt", {
        Title = "Health (%)",
        Description = "",
        Default = 25,
        Min = 0,
...
spawn(function()
    ...
    local ToggleCakeV2 = Tabs.FARM:AddToggle("ToggleCakeV2", {Title = "Auto Farm Dough King",Description = "", Default = false })
...
while wait() do
    ...
    local AutoElite = Tabs.FARM:AddSection("Elite Hunter Farm")

    local StatusElite = Tabs.FARM:AddParagraph({
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Snipe Fruit",Description = "", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Auto Buy Random Fruit",Description = "", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Bring Fruit",Description = "", Default = false })
...
local ToggleCollectTP = Tabs.Fruit:AddToggle("ToggleCollectTP", {Title = "Tp Bring Fruit",Description = "", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Auto Buy Bone",Description = "", Default = false })
...
if Second_Sea or Third_Sea then
    local ToggleHakiColor = Tabs.Shop:AddToggle("ToggleHakiColor", {Title = "Auto Buy Haki Color",Description = "",Default = false })
...
if Second_Sea then
    local ToggleSwordLengend = Tabs.Shop:AddToggle("ToggleSwordLengend", {Title = "Auto Buy Sword Lengendary",Description = "",Default = false })
