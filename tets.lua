...
jackhub_key = "khanhbanglaso1"

if jackhub_key == "khanhbanglaso1" then
            ...
            function()
                while wait() do
                    if _G.KAITAN1CLICK then
                        ...
                        if MyLevel >= 1 then
                            V.Text = "Auto Status: Redeem Code"
                            ...
                            if g.Name == "Shanda" then
                                if
                                 ...
                                 then
                                    repeat
                                        task.wait()
                                        T.Text = "Kaitun Free /By Nguyen Vu Duy "
                                        EquipWeapon(_G.Select_Weapon)
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                        g.HumanoidRootPart.CanCollide = false
                                        g.Humanoid.WalkSpeed = 0
                                ...
                                if ao == nil then
                                    if
                                        game:GetService("Lighting").Sky.MoonTextureId ==
                                            "http://www.roblox.com/asset/?id=16601446273"
                                     then
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(
                                            "gravestoneEvent",
                                            2
