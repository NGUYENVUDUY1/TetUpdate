...
local AutoFarmSaberToggle = Tabs.ITM:AddToggle("AutoSaber_Toggle", {Title = "Auto Saber", Default = false })
...
local AutoFarmPoleToggle = Tabs.ITM:AddToggle("AutoPole_Toggle", {Title = "Auto Pole", Default = false })
