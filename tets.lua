...
button.BackgroundColor3 = Color3.fromRGB(245, 66, 66) -- Màu xanh nước biển
...
local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/Nchanquadi/Horima/main/hiruhub_main.lua"))()
...
local Tabs = {
    ...
    Sea = Window:AddTab({ Title = "Tab Sea Event", Icon = "align-vertical-distribute-center" }),
