...
local Window = Fluent:CreateWindow({
    Title = "Hiru Hub",
    SubTitle = "Version Beta 6¹ | By Nguyen Vu Duy",
    TabWidth = 160,
...
local boss = Tabs.Main:AddSection("Boss Farm")
	...
	local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {Title = "Auto Kill Boss", Description = "", Default = false })
...
local ToggleAutoT = Tabs.Setting:AddToggle("ToggleAutoT", {Title = "Enabled Turn On V3", Description = "", Default = false })
...
local ToggleAutoY = Tabs.Setting:AddToggle("ToggleAutoY", {Title = "Enabled Turn On V4", Description = "", Default = false })
