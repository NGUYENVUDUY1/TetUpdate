...
local Tabs = {
    ...
    Farm = Window:AddTab({ Title = "Tab Items", Icon = "" }),
...
if Third_Sea then
    local ToggleCakeV2 = Tabs.Farm:AddToggle("ToggleCakeV2", {Title = "Auto Kill Dought King (Need Spawn)",Description = "", Default = false })
