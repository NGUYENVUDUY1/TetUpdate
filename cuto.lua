...
local Tabs = {
    ...
    Auto = Window:AddTab({ Title = "Tab Auto Farming", Icon = "" }),
...
Tabs.Main:AddButton({
        ...
        Description = "",
        Callback = function()
            setclipboard("https://discord.com/invite/8nZD8ruh")
        end
    })
...
local SKill = Tabs.Farm:AddSection("Skill Mastery")
local ToggleZ = Tabs.Farm:AddToggle("ToggleZ", {Title = "Skill Z",Description = "", Default = true })
ToggleZ:OnChanged(function(Value)
    SkillZ = Value
end)
Options.ToggleZ:SetValue(true)

local ToggleX = Tabs.Farm:AddToggle("ToggleX", {Title = "Skill X", Description = "",Default = true })
...
local ToggleC = Tabs.Farm:AddToggle("ToggleC", {Title = "Skill C",Description = "", Default = true })
...
local ToggleV = Tabs.Farm:AddToggle("ToggleV", {Title = "Skill V",Description = "", Default = true })
...
local ToggleF = Tabs.Farm:AddToggle("ToggleF", {Title = "Skill F",Description = "", Default = false })
...
local Pos = Tabs.Farm:AddSection("Distance Farm")

local SliderPosX = Tabs.Farm:AddSlider("SliderPosX", {
    Title = "Pos X",
    Description = "",
    Default = 0,
    Min = -60,
...
local SliderPosY = Tabs.Farm:AddSlider("SliderPosY", {
    Title = "Pos Y",
    Description = "",
    Default = 30,
    Min = -60,
...
local SliderPosZ = Tabs.Farm:AddSlider("SliderPosZ", {
    Title = "Pos Z",
    Description = "",
    Default = 0,
    Min = -60,
...
local Material = Tabs.Auto:AddSection("Material Farm")
    ...
    local DropdownMaterial = Tabs.Auto:AddDropdown("DropdownMaterial", {
    ...
    local ToggleMaterial = Tabs.Auto:AddToggle("ToggleMaterial", {
...
local ToggleBone = Tabs.Auto:AddToggle("ToggleBone", {
...
if Third_Sea then
local MiscFarm = Tabs.Auto:AddSection("Katakuri Farm")
local Mob_Kill_Cake_Prince = Tabs.Auto:AddParagraph({
...
local ToggleCake = Tabs.Auto:AddToggle("ToggleCake", {
...
local ToggleSpawnCake = Tabs.Auto:AddToggle("ToggleSpawnCake", {
        Title = "Auto Spam Prince",
        Description = "", 
        Default = true })
...
local AutoElite = Tabs.Auto:AddSection("Elite Hunter Farm")

    local StatusElite = Tabs.Auto:AddParagraph({
    ...
    local ToggleElite = Tabs.Auto:AddToggle("ToggleElite", {Title = "Auto kill Elite",Description = "", Default = false })
...
if Third_Sea then
    local ToggleCakeV2 = Tabs.Auto:AddToggle("ToggleCakeV2", {Title = "Auto Farm Dough King",Description = "", Default = false })
    ...
    local ToggleMobAura = Tabs.Auto:AddToggle("ToggleMobAura", {
    ...
    local ToggleCastleRaid = Tabs.Auto:AddToggle("ToggleCastleRaid", {
    ...
    if Second_Sea then
	local MiscFarm = Tabs.Auto:AddSection("Ectoplasm Farm")
    local ToggleVatChatKiDi = Tabs.Auto:AddToggle("ToggleVatChatKiDi", {
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Auto Bring Fruit",Description = "", Default = false })
...
local Mastery = Tabs.Shop:AddSection("Buy")
