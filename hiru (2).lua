...
local Tabs = {
    profile = Window:AddTab({ Title = "Information", Icon = "" }),
...
Tabs.profile:AddParagraph({
 ...
 Tabs.profile:AddParagraph({
        Title = "Hiru Hub Làm Nên Thương Hiệu",
        Content = "VN"
    })   
...
local listfastattack = {'Slow','Normal','Extre','Fast'}
	...
	elseif _G.FastAttackHiruHub_Mode == "Normal" then
		_G.Fast_Delay = 0.12	
	elseif _G.FastAttackHiruHub_Mode == "Extre" then
		_G.Fast_Delay = 0.5
...
local Togglehakiqs = Tabs.Setting:AddToggle("Togglehakiqs", {Title = "Auto Turn Ken Haki", Description = "", Default = false })
