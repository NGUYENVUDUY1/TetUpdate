...
notify.New("Script by minevn2", 60)
...
Muxus("<Color=Green>-Cảm Ơn Vì Đã Sử Dụng Script Của Muxus-<Color=/>")
...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://17347777526"
...
ImageButton1.Image = "rbxassetid://17347777526" -- ảnh button ở ngoài --
...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "discord.gg/VSxTQuDxfN                                       [RightControl]"
