...
--- Load & Save Setting
local foldername = "Winter Hub Bounty"
...
local Window = OrionLib:MakeWindow({Name = "Winter Hub Bounty", HidePremium = false, SaveConfig = true, ConfigFolder = "Winter Hub Bounty Config"})
--- Counter
...
game:GetService("CoreGui").RobloxPromptGui.promptOverlay.ChildAdded:Connect(function(child)
    if not hopserver and child.Name == 'ErrorPrompt' and child:FindFirstChild('MessageArea') and child.MessageArea:FindFirstChild("ErrorFrame") then
        ...
        Notify("Winter Hub Bounty | Rejoin from kicked!")
    end
end)
--- Webhook
function wSend(main)
