...
local Window = SpeedHubX:CreateWindow({
    Title = "Hiru Hub",
    SubTitle = "Version Beta 9¹ | By Nguyen Vu Duy",
    TabWidth = 160,
...
local Tabs = {
    profile = Window:AddTab({ Title = "Tab information", Icon = "" }),
    Main = Window:AddTab({ Title = "Tab Main", Icon = "" }),
    FAR = Window:AddTab({ Title = "Tab Farm", Icon = "" }),
    ...
    Status = Window:AddTab({ Title = "Tab Server Stats", Icon = "" }),
    ...
    Fruit = Window:AddTab({ Title = "Tab Fruit Blox Esp", Icon = "" }),
    Raid = Window:AddTab({ Title = "Tab Dungeon", Icon = "" }),
    Race = Window:AddTab({ Title = "Tab Race Trial V4", Icon = "" }),
    Shop = Window:AddTab({ Title = "Tab Shop", Icon = "" }),
	Misc = Window:AddTab({ Title = "Tab Miscellaneous", Icon = "" }),
    Hop = Window:AddTab({ Title = "Tab Hop Server", Icon = "" }),
}
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/NGUYENVUDUY1/Levelchcek/main/filelevl.lua"))() 
...
--// Check Boss Quest
loadstring(game:HttpGet("https://raw.githubusercontent.com/NGUYENVUDUY1/Helo.lua/main/filelevl.lua"))() 

--// Check Material
loadstring(game:HttpGet("https://raw.githubusercontent.com/NGUYENVUDUY1/Hilo/main/filelevl.lua"))() 
...
--Check Material
loadstring(game:HttpGet("https://raw.githubusercontent.com/NGUYENVUDUY1/Mark/main/filelevl.lua"))()
...
ImageButton.Image = "http://www.roblox.com/asset/?id=17272575521"
...
local listfastattack = {'0.1','0.05','0.04','0.005','0.5','0.02'}
    ...
    _G.m1m_Mode = Value
	if _G.memaybeo_Mode == "0.04" then
		_G.Fast_Delay = 0.1
    elseif _G.memaybeo_Mode == "0.05" then
		_G.Fast_Delay = 0.05
	elseif _G.memaybeo_Mode == "0.005" then
        _G.Fast_Delay = 0.005
    elseif _G.memaybeo_Mode == "0.001" then
		_G.Fast_Delay = 0.001
    elseif _G.memaybeo_Mode == "0.5" then
		_G.Fast_Delay = 0.0004
    elseif _G.memaybeo_Mode == "0.1" then
        _G.Fast_Delay = 0.00009
    elseif _G.memaybeo_Mode == "0.02" then
        _G.Fast_Delay = 0.02
	end
end)
...
local ToggleFastAttack = Tabs.Main:AddToggle("ToggleFastAttack", {Title = "Fast Attack", Description = "", Default = true })
...
local ToggleBypassTP = Tabs.Main:AddToggle("ToggleBypassTP", {Title = "Bypass Tp",Description = "", Default = false })
...
local ToggleRemove = Tabs.Main:AddToggle("ToggleRemove", {Title = "Remove Dame Text",Description = "", Default = true })
...
local ToggleRemoveNotify = Tabs.Main:AddToggle("ToggleRemoveNotify", {Title = "Remove All Notify",Description = "", Default = false })
...
local ToggleZ = Tabs.Main:AddToggle("ToggleZ", {Title = "Spam Skill Z",Description = "", Default = true })
ToggleZ:OnChanged(function(Value)
    SkillZ = Value
end)
Options.ToggleZ:SetValue(true)

local ToggleX = Tabs.Main:AddToggle("ToggleX", {Title = "Spam Skill X", Description = "",Default = true })
...
local ToggleC = Tabs.Main:AddToggle("ToggleC", {Title = "Spam Skill C",Description = "", Default = true })
...
local ToggleV = Tabs.Main:AddToggle("ToggleV", {Title = "Spam Skill V",Description = "", Default = true })
...
local ToggleF = Tabs.Main:AddToggle("ToggleF", {Title = "Spam Skill F",Description = "", Default = false })
...
local MiscFarm = Tabs.Main:AddSection("Pos Skill")


local SliderPosX = Tabs.Main:AddSlider("SliderPosX", {
    Title = "Pos X",
    Description = "",
    Default = 0,
    Min = -60,
...
local SliderPosY = Tabs.Main:AddSlider("SliderPosY", {
    Title = "Pos Y",
    Description = "",
    Default = 30,
    Min = -60,
...
local SliderPosZ = Tabs.Main:AddSlider("SliderPosZ", {
    Title = "Pos Z",
    Description = "",
    Default = 0,
    Min = -60,
...
local ToggleRejoin = Tabs.Main:AddToggle("ToggleRejoin", {Title = "Auto Rejoin On Kick", Description = "",Default = true })
...
local ToggleAutoT = Tabs.Main:AddToggle("ToggleAutoT", {Title = "Auto Turn On V3", Description = "", Default = false })
...
local ToggleAutoY = Tabs.Main:AddToggle("ToggleAutoY", {Title = "Auto Turn On V4", Description = "", Default = false })
...
local ToggleLevel = Tabs.FAR:AddToggle("ToggleLevel", {
...
local ToggleBringMob = Tabs.FAR:AddToggle("ToggleBringMob", {Title = "Bring Mob",Description = "", Default = true })
    ...
    local ToggleMobAura = Tabs.FAR:AddToggle("ToggleMobAura", {
...
local ToggleWhite = Tabs.FAR:AddToggle("ToggleWhite", {Title = "White Screen",Description = "", Default = false })
    ...
    local ToggleCastleRaid = Tabs.FAR:AddToggle("ToggleCastleRaid", {
...
local boss = Tabs.FAR:AddSection("Boss Farm")
    ...
    local DropdownBoss = Tabs.FAR:AddDropdown("DropdownBoss", {
        Title = "choose boss",
        Description = "",
        Values = tableBoss,
        Multi = false,
	...
	local ToggleAutoFarmBoss = Tabs.FAR:AddToggle("ToggleAutoFarmBoss", {
...
local Mastery = Tabs.FAR:AddSection("Mastery Farm")
    local DropdownMastery = Tabs.FAR:AddDropdown("DropdownMastery", {
    ...
    local ToggleMasteryFruit = Tabs.FAR:AddToggle("ToggleMasteryFruit", {
    ...
    local SliderHealt = Tabs.FAR:AddSlider("SliderHealt", {
        Title = "Health (%) Mob",
        Description = "",
        Default = 25,
        Min = 0,
...
if Third_Sea then
local MiscFarm = Tabs.FAR:AddSection("Bone Farm")

local StatusBone = Tabs.FAR:AddParagraph({
    Title = "Bone Status",
    Content = ""
})
	spawn(function()
...
local ToggleBone = Tabs.FAR:AddToggle("ToggleBone", {
...
local ToggleRandomBone = Tabs.FAR:AddToggle("ToggleRandomBone", {Title = "Auto Random Bone",Description = "", Default = false })
...
if Third_Sea then
local MiscFarm = Tabs.FAR:AddSection("Katakuri Farm")
local Mob_Kill_Cake_Prince = Tabs.FAR:AddParagraph({
...
local ToggleCake = Tabs.FAR:AddToggle("ToggleCake", {
...
spawn(function()
    ...
    local ToggleSpawnCake = Tabs.FAR:AddToggle("ToggleSpawnCake", {
...
spawn(function()
  while wait() do
    ...
    if Second_Sea then
	local MiscFarm = Tabs.FAR:AddSection("Ectoplasm Farm")
    local ToggleVatChatKiDi = Tabs.FAR:AddToggle("ToggleVatChatKiDi", {
...
local AutoElite = Tabs.FAR:AddSection("Elite Hunter Farm")

    local StatusElite = Tabs.FAR:AddParagraph({
    ...
    local ToggleElite = Tabs.FAR:AddToggle("ToggleElite", {Title = "Auto kill Elite Hunter",Description = "", Default = false })
    ...
    local Material = Tabs.FAR:AddSection("Material Farm")
    ...
    local DropdownMaterial = Tabs.FAR:AddDropdown("DropdownMaterial", {
    ...
    local ToggleMaterial = Tabs.FAR:AddToggle("ToggleMaterial", {
...
local ToggleAutoSoulGuitar = Tabs.ITM:AddToggle("ToggleAutoSoulGuitar", {Title = "Auto Soul guitar",Description = "", Default = false })
...
if Second_Sea then
    local ToggleEvoRace = Tabs.ITM:AddToggle("ToggleEvoRace", {Title = "Auto Quest Flower",Description = "",Default = false })
...
Tabs.profile:AddButton({
        ...
        Description = "Hãy Tham Gia Discord Thông Báo Update!",
        Callback = function()
            setclipboard("https://discord.com/invite/hjZa2MW5")
        end
    })      
