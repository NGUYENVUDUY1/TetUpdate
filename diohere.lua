...
local Tabs = {
    profile = Window:AddTab({ Title = "Tab information", Icon = "activity" }),
    ...
    Status = Window:AddTab({ Title = "Tab Server Stats", Icon = "user" }),
