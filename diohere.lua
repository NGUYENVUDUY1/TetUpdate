...
local ToggleRejoin = Tabs.Misc:AddToggle("ToggleRejoin", {Title = "Auto Rejoin On Kick", Description = "",Default = true })
...
local ToggleBringMob = Tabs.Main:AddToggle("ToggleBringMob", {Title = "Bring Mob",Description = "", Default = true })
...
local ToggleWhite = Tabs.Main:AddToggle("ToggleWhite", {Title = "White Screen",Description = "", Default = false })
