...
local Mastery = Tabs.Main:AddSection("Chest Farm")
...
local ToggleFindMoon = Tabs.Main:AddToggle("ToggleFindMoon", {Title = "Auto Chest Hop Server",Description = "", Default = false })
...
local SKill = Tabs.Main:AddSection("Skill Mastery")
...
local Pos = Tabs.Main:AddSection("Distance Farm")
...
local ToggleBringMob = Tabs.Farm:AddToggle("ToggleBringMob", {Title = "Bring Mob",Description = "", Default = true })
...
local ToggleFastAttack = Tabs.Farm:AddToggle("ToggleFastAttack", {Title = "Fast Attack", Description = "", Default = true })
...
local ToggleWhite = Tabs.Farm:AddToggle("ToggleWhite", {Title = "White Screen",Description = "", Default = false })
    ...
    local ToggleMobAura = Tabs.Farm:AddToggle("ToggleMobAura", {
...
local boss = Tabs.Farm:AddSection("Boss Farm")
	...
	local ToggleAutoFarmBoss = Tabs.Farm:AddToggle("ToggleAutoFarmBoss", {
    ...
    local ToggleCastleRaid = Tabs.Farm:AddToggle("ToggleCastleRaid", {
...
local Mastery = Tabs.Farm:AddSection("Mastery Farm")
    local DropdownMastery = Tabs.Farm:AddDropdown("DropdownMastery", {
    ...
    local ToggleMasteryFruit = Tabs.Farm:AddToggle("ToggleMasteryFruit", {
    ...
    local SliderHealt = Tabs.Farm:AddSlider("SliderHealt", {
        Title = "Health (%) Mob",
        Description = "",
        Default = 25,
        Min = 0,
...
if Third_Sea then
local MiscFarm = Tabs.Farm:AddSection("Bone Farm")

local StatusBone = Tabs.Farm:AddParagraph({
    Title = "Bone Status",
    Content = ""
})
	spawn(function()
...
local ToggleBone = Tabs.Farm:AddToggle("ToggleBone", {
...
local ToggleRandomBone = Tabs.Farm:AddToggle("ToggleRandomBone", {Title = "Auto Random Bone",Description = "", Default = false })
...
if Third_Sea then
local MiscFarm = Tabs.Farm:AddSection("Katakuri Farm")
local Mob_Kill_Cake_Prince = Tabs.Farm:AddParagraph({
...
local ToggleCake = Tabs.Farm:AddToggle("ToggleCake", {
...
spawn(function()
    ...
    local ToggleSpawnCake = Tabs.Farm:AddToggle("ToggleSpawnCake", {
...
spawn(function()
  while wait() do
    ...
    if Second_Sea then
	local MiscFarm = Tabs.Farm:AddSection("Ectoplasm Farm")
    local ToggleVatChatKiDi = Tabs.Farm:AddToggle("ToggleVatChatKiDi", {
    ...
    local Material = Tabs.Farm:AddSection("Material Farm")
    ...
    local DropdownMaterial = Tabs.Farm:AddDropdown("DropdownMaterial", {
    ...
    local ToggleMaterial = Tabs.Farm:AddToggle("ToggleMaterial", {
    ...
    local ToggleElite = Tabs.Farm:AddToggle("ToggleElite", {Title = "Auto kill Elite Hunter",Description = "", Default = false })
...
local ToggleAutoSoulGuitar = Tabs.Main:AddToggle("ToggleAutoSoulGuitar", {Title = "Auto Get Soulguitar",Description = "", Default = false })
