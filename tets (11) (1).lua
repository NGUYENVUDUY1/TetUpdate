...
local Window = Fluent:CreateWindow({
    Title = "Hiru Hub",
    SubTitle = "Version Beta 7¹ | By Nguyen Vu Duy",
    TabWidth = 160,
...
local listfastattack = {'0.01','0.05','0.015','0.001','0.1','0.005','0','0.02'}
    ...
    DropdownDelayAttack:SetValue("0.01")
    ...
    local ToggleCastleRaid = Tabs.Main:AddToggle("ToggleCastleRaid", {
        Title = "Auto Pirates Castle Raid《Sea3》",
        Description = "", 
        Default = false })
...
local ToggleRandomBone = Tabs.Main:AddToggle("ToggleRandomBone", {Title = "Auto Random Bone《Sea3》",Description = "", Default = false })
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {
    Title = "Auto Farm Cake Prince《Sea3》",
    Description = "", 
    Default = false })
...
spawn(function()
    pcall(function()
      ...
      local ToggleEspKitsune = Tabs.Sea:AddToggle("ToggleEspKitsune", {Title = "Esp Kitsune Event Island《Sea3》",Description = "", Default = false })
      ...
      local ToggleTPKitsune = Tabs.Sea:AddToggle("ToggleTPKitsune", {Title = "Tween To Kitsune Island《Se3》",Description = "", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Sea:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Ambers《Sea3》",Description = "", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Sea:AddToggle("ToggleSailBoat", {Title = "Auto Buy Boat + Zone 6《Sea3》",Description = "", Default = false })
...
local SpeedBoatToggle = Tabs.Sea:AddToggle("SpeedBoat_Toggle", {Title = "Auto Speed Boat《Sea3》",Description = "", Default = false })
...
game:GetService("RunService").RenderStepped:Connect(function()
    ...
    local ToggleTerrorshark = Tabs.Sea:AddToggle("ToggleTerrorshark", {Title = "Auto Kill Terrorshark《Sea3》",Description = "", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.Sea:AddToggle("TogglePiranha", {Title = "Auto Kill Piranha《Sea3》",Description = "", Default = false })
     ...
     local ToggleShark = Tabs.Sea:AddToggle("ToggleShark", {Title = "Auto Kill Shark《Sea3》",Description = "", Default = false })
...
local ToggleSeaBeAst = Tabs.Sea:AddToggle("ToggleSeaBeAst", {Title = "Auto Kill Sea Beast + Ghost Ship《Sea3》",Description = "", Default = false })
...
ToggleSeaBeAst:OnChanged(function(Value)
    ...
    local ToggleFishCrew = Tabs.Sea:AddToggle("ToggleFishCrew", {Title = "Auto Kill Fish Crew《Sea3》",Description = "", Default = false })
    ...
    local ToggleShip = Tabs.Sea:AddToggle("ToggleShip", {Title = "Auto Kill Ship《Sea3》",Description = "", Default = false })
...
while wait() do
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Auto kill Elite Hunter《Sea3》",Description = "", Default = false })
...
ToggleAutoW:OnChanged(function(Value)
 ...
 spawn(function()
    ...
    Tabs.Sea:AddButton({
        Title = "Auto Tween to Mirage Island《Sea3》",
        Description = "",
        Callback = function()
            TweenMirage()
        end
    ...
    Tabs.Sea:AddButton({
        Title = "Tween to Highest Point《Sea3》",
        Description = "",
        Callback = function()
            TwenetoHighestPoint()
        end
...
local ToggleTweenGear = Tabs.Sea:AddToggle("ToggleTweenGear", {Title = "Tween To Gear《Sea3》",Description = "", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Sea:AddToggle("Togglelockmoon", {Title = "Lock Moon and Use Race Skill《Sea3》",Description = "", Default = false })
...
local ToggleMirage = Tabs.Sea:AddToggle("ToggleMirage", {Title = "Auto hang Mirage Island《Sea3》",Description = "", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.ITM:AddToggle("ToggleHallow", {Title = "Auto Hallow Scythe [Fully]《Sea3》",Description = "", Default = false })
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.ITM:AddToggle("ToggleYama", {Title = "Auto Get Yama《Sea3》",Description = "", Default = false })
        ...
        local ToggleTushita = Tabs.ITM:AddToggle("ToggleTushita", {Title = "Auto Get Tushita《Sea3》",Description = "", Default = false })
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.ITM:AddToggle("ToggleHoly", {Title = "Auto Holy Torch《Sea3》",Description = "", Default = false })
...
if Second_Sea then
        local ToggleFactory = Tabs.ITM:AddToggle("ToggleFactory", {Title = "Auto Farm Factory《Sea2》",Description = "", Default = false })
...
local Togglev2obs = Tabs.ITM:AddToggle("Togglev2obs", {Title = "Auto Observation Haki V2《Sea3》", Description = "", Default = false })
...
local ToggleKillPlayerTrial = Tabs.ITM:AddToggle("ToggleKillPlayerTrial", {Title = "Auto Cursed Dual Katana《Sea3》",Description = "", Default = false })
ToggleKillPlayerTrial:OnChanged(function(Value)
    _G.KillAfterTrials = value
end)

        if Third_Sea then
    local ToggleCakeV2 = Tabs.ITM:AddToggle("ToggleCakeV2", {Title = "Auto Kill Dought King Need Spawn《Sea3》",Description = "", Default = false })
...
if Second_Sea then
    local ToggleSwordLengend = Tabs.Main:AddToggle("ToggleSwordLengend", {Title = "Auto Buy Sword Lengendary《Sea2》",Description = "",Default = false })
...
local Mastery = Tabs.Shop:AddSection("Buy Mele")
...
local args = {[1] = "CyborgTrainer", [2] = "Buy"}
    ...
    Tabs.Shop:AddButton({
        ...
        Description = "100 strange material",
        Callback = function()            
