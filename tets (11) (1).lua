...
local Window = SpeedHubX:CreateWindow({
    Title = "Hitu Hub",
    SubTitle = "Version Beta 8¹ | Bản Nâng Cấp của Hiru Hub",
    TabWidth = 160,
...
local listfastattack = {'cực béo','0.05','0.1','0.005','béo','0.02'}
    ...
    DropdownDelayAttack:SetValue("béo")
    DropdownDelayAttack:OnChanged(function(Value)
    _G.m1m_Mode = Value
	if _G.memaybeo_Mode == "0.1" then
		_G.Fast_Delay = 0.1
    ...
    elseif _G.memaybeo_Mode == "0.001" then
		_G.Fast_Delay = 0.001
    elseif _G.memaybeo_Mode == "béo" then
		_G.Fast_Delay = 0.0004
    elseif _G.memaybeo_Mode == "cực béo" then
