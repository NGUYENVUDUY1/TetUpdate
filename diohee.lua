local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/Winterne/Diohere/main/diohere_main.lua"))()
...
local Tabs = {
    profile = Window:AddTab({ Title = "Tab information", Icon = "apple" }),
    Main = Window:AddTab({ Title = "Tab Main Farm", Icon = "apple" }),
    Sea = Window:AddTab({ Title = "Tab Sea Event", Icon = "apple" }),
    Setting = Window:AddTab({ Title = "Tab Setting", Icon = "apple" }),
    Status = Window:AddTab({ Title = "Tab Server Stats", Icon = "apple" }),
    Stats = Window:AddTab({ Title = "Tab Stats", Icon = "apple" }),
    Player = Window:AddTab({ Title = "Tab Player", Icon = "apple" }),
    Teleport = Window:AddTab({ Title = "Tab Teleport", Icon = "apple" }),
    Fruit = Window:AddTab({ Title = "Tab Fruit Blox ESP", Icon = "apple" }),
    Raid = Window:AddTab({ Title = "Tab Dungeon", Icon = "apple" }),
    Race = Window:AddTab({ Title = "Tab Race Trial V4", Icon = "apple" }),
    Shop = Window:AddTab({ Title = "Tab Shopee", Icon = "apple" }),
	Misc = Window:AddTab({ Title = "Tab Miscellaneous", Icon = "apple" }),
    Hop = Window:AddTab({ Title = "Tab Hop Server", Icon = "apple" }),
}
...
ImageButton.Image = "http://www.roblox.com/asset/?id=17218301832"
...
local listfastattack = {'Normal','Slow','Super'}
    ...
    _G.FastAttackSkyxhub_Mode = Value
	if _G.FastAttackSkyxhub_Mode == "Slow" then
		_G.Fast_Delay = 0.2
	elseif _G.FastAttackSkyxhub_Mode == "Normal" then
		_G.Fast_Delay = 0.12	
	elseif _G.FastAttackSkyxhub_Mode == "Extra" then
		_G.Fast_Delay = 0
	end
end)
